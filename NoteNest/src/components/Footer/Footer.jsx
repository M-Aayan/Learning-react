        ...
        <div>
            <footer className='bg-purple-100'>
                <div className='p-4 flex gap-5'>
                        <div className='p-5'>
                            <h1 className='font-medium text-2xl mb-3' >About</h1>
                            <p>NoteNest is a simple note-taking app built to help you capture your thoughts, <br /> ideas, and important notes in a clean and organized way.</p>
                        </div>
